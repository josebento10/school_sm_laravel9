            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        <h3 class="page-title">Bem-vindo {{ Session::get('name') }}!</h3>
                        <ul class="breadcrumb">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-6">
                                <ul class="chart-list-out">
                                    <li><span class="circle-blue"></span>Professor</li>
                                    <li><span class="circle-green"></span>Aluno</li>
                ...
                <div class="card card-chart">
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-6">
                                <ul class="chart-list-out">
                                    <li><span class="circle-blue"></span>Mulheres</li>
                                    <li><span class="circle-green"></span>Homens</li>
                                    <li><span class="circle-green"></span>indefinido</li>
                                    <li class="star-menus"><a href="javascript:;"><i
                                                class="fas fa-ellipsis-v"></i></a></li>
                                </ul>
                            </div>
        ...
        <div class="row">
            <div class="col-xl-6 d-flex">
                ...
                <div class="card flex-fill student-space comman-shadow">
                    <div class="card-header d-flex align-items-center">
                        <h5 class="card-title">Alunos Destaques</h5>
            ...
            <div class="col-xl-6 d-flex">
                ...
                <div class="card flex-fill comman-shadow">
                    <div class="card-header d-flex align-items-center">
                        <h5 class="card-title ">Atividade Estudantil </h5>
                        <ul class="chart-list-out student-ellips">
                            <li class="star-menus"><a href="javascript:;"><i class="fas fa-ellipsis-v"></i></a>
                            </li>
                        </ul>
