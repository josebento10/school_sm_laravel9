            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('setting/page') }}">Configurações</a></li>
            ...
            <div class="settings-menu-links">
                <ul class="nav nav-tabs menu-tabs">
                    <li class="nav-item active">
                        <a class="nav-link" href="settings.html">Configurações Gerais</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="localization-details.html">Localização</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="payment-settings.html">Pagamentos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="email-settings.html">E-mail</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="social-settings.html">Redes sociais</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="social-links.html">Links Sociais</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="seo-settings.html">SEO</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="others-settings.html">Outros</a>
                    </li>
                </ul>
            </div>
