...
<div class="login-right">
    <div class="login-right-wrap">
        <h1>Bem-vindo ao TrâmiSchool</h1>
        <p class="account-subtitle">Precisa de uma conta? <a href="{{ route('register') }}">Inscrever-se</a></p>
        <h2>Entrar</h2>
        <form action="{{ route('login') }}" method="POST">
            ...
            <div class="forgotpass">
                <div class="remember-me">
                    <label class="custom_check mr-2 mb-0 d-inline-flex remember-me"> Lembrar-me
